  ...
  request(options, function (error, response, body) {
    ...
    for (let i = 0; i < size; i++) {
      try {
        ...
        if (
          body.situations[i].district.parent.name === "Košický kraj" ||
          body.situations[i].district.parent.name === "Prešovský kraj"
        ) {
          body.situations[i].Id = ++count;
          body.situations[i].Type = "Traffic";
          body.situations[i].CurrentTime = currentTime;
          delete body.situations[i].photosInfo;
          delete body.situations[i].id;
          delete body.situations[i].guid;
          delete body.situations[i].region;
          delete body.situations[i].district.parent.parent;
          delete body.situations[i].district.parent.areaLevel;          
          //console.log(body.situations[i]);
